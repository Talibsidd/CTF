                ...
                <div class="page-content">
                    ...
                    <div class="col-xl-12  text-center">
                        ...
                        <div class="float-left">
                            <h4 class="text-white-emphasis bold">GS_Basic Score: &nbsp;
                                <?php if (isset($GS_level1_score))
                                    echo $GS_level1_score; ?><br><br>
                            </h4>
                        </div>

                        <div class="float-right">
                        
                            <?php include_once './includes/timer.php'; ?>
                        </div>
                    ...
                    <div class="row">
                        ...
                        for ($i = 1; $i <= 20; $i++) {
                            ...
                            echo '<span class="badge text-bg-info">50 points</span>
                                         ...
                                         <p>' . $GS_questions[$i - 1] . '</p>
                                         <a  href="'.$GS_level1_links[$i-1].'" class="btn btn-outline-secondary btn-shadow"><span class="fa fa-download mr-2"></span>Redirect</a>
                                       ...
                                       <form action="GS_level1.php" method="post" id="questForm">
